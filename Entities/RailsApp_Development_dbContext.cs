...
{
    public partial class  RailsApp_development_dbContext : DbContext
    {
        public  RailsApp_development_dbContext()
        {
        }

        public  RailsApp_development_dbContext(DbContextOptions<RailsApp_development_dbContext> options)
            : base(options)
        {
        }
        public virtual DbSet<Buildings.Addresses> Address { get; set; }
        public virtual DbSet<Batteries> Battery { get; set; }
        public virtual DbSet<Buildings> Building { get; set; }
        public virtual DbSet<BuildingsDetails> BuildingsDetail { get; set; }
        public virtual DbSet<Columns> Column { get; set; }
        ...
        public virtual DbSet<Leads> Lead { get; set; }
        public virtual DbSet<Quotes> Quote { get; set; }
        public virtual DbSet<SchemaMigration> SchemaMigration { get; set; }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseMySql("Server=localhost;Port=3306;Database=RailsApp_development; uid=root;password=Codeboxx1!");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BuildingsDetails>(entity =>
            {
